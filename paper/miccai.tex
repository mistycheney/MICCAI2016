...
One of the most important tools to neuroscientists, a brain atlas
...
In this paper we focus on building an atlas for the mouse brainstem using light microscopy.
